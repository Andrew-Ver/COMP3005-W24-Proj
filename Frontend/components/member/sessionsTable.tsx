...
const Table = () => {
    ...
    const handleMarkAsCompleted = () => {
        modals.openConfirmModal({
            ...
            children: (
                <Text size="sm">
                    Are you sure you want to mark the selected sessions as
                    completed?
                </Text>
            ),
    ...
    const handleRefund = () => {
        modals.openConfirmModal({
            ...
            children: (
                <Text size="sm">
                    Are you sure you want to cancel and refund the selected
                    sessions?
                </Text>
            ),
            labels: { confirm: 'Confirm', cancel: 'Cancel' },
    ...
    const handleCompletionConfirmed = async () => {
        ...
        try {
            const response = await fetch(
                '/api/member/personal-training/complete',
                {
                    method: 'POST',
                    headers: {
    ...
    const handleRefundConfirmed = async () => {
        ...
        try {
            const response = await fetch(
                '/api/member/personal-training/refund',
                {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
