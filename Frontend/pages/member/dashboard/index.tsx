...
export default function Dashboard() {
    ...
    const { data: metrics, isLoading, isError, error } = useQuery({
        ...
        queryFn: () => fetchMetrics(member_username)
    });
    ...
    return (
        <>
            <Title order={1} style={{ color: 'rgb(73, 105, 137)', textAlign: 'center' }}>
                Member Dashboard
            </Title>
