...
export default async function getUserHealthMetrics(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        if (result.rows.length > 0) {
            ...
            const formattedResult = {
                ...
                avg_body_fat: parseFloat(row.avg_body_fat_percentage).toFixed(2),
                ...
                latest_body_fat: parseFloat(row.latest_body_fat_percentage).toFixed(2),
